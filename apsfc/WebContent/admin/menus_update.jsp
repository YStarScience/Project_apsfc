	...
	<table width="100%" height="1" border="0" cellpadding="0"
		...
		<tr>
			<td valign="top" bgcolor="#F7F8F9">
				<p>修改菜单</p>
				<div align="center">
					<form action="${pageContext.request.contextPath }/MenuServlet?action=updateMenu&id=${menu.id}" method="post"
						...
						<table id="table2" class="line_table"
							...
							<tr>
								...
								<td class="line_table" width="80%" align="left"><img
									src="${pageContext.request.contextPath}/${menu.imgpath}"><input type="hidden" name="id" value="1"/></td>
							</tr>
