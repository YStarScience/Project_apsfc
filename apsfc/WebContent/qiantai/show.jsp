  ...
  <tr>
    ...
    <table id="table2"   class="line_table" style="width:100%;  margin: 0; padding: 0" cellSpacing="0" cellPadding="0">
		...
		<tr>
			...
			价：</span></td>
			<td height="25"  width="80%">
			<input type="text" name="price1" size="45" readonly value="${menu.price }"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<input type="text" name="type" size="45" readonly value="${type.name }"></td>
		...
		<tr>
			...
			<a href="qiantai/index.jsp" target="_self"><input type="submit" value="返回"></a>
			</td>
		</tr>
