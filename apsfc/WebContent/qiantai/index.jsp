...
<body style='background: transparent'>
	...
	<!-- 第一访问的时候--》请求IndexServlet(分页查询所有菜品、查询所有公告) -->
															...
															<div id="dingcanweekmenu2">
																...
																<div style="padding: px;">
																	<div class="dingcanweekmenuinfo" align="left">
																		<c:forEach items="${menutop}" var="menu">
 																			<li class="newslist_time2"><div class="time">已销售${menu.sums1}次</div>
																				<a href="ShowServlet?id=${menu.id}" class="newslist_time2">${menu.name}</a></li>
																		</c:forEach>
																	</div>
																</div>
															</div>
